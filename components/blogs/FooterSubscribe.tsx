          ...
          <div className="row-gap-10 grid gap-6 md:grid-cols-2">
            <div className="mx-auto md:my-auto md:ml-0 md:pb-6 md:pr-24">
              ...
              <p className="text-center text-xl text-gray-200 dark:text-slate-300 md:text-left">
                ...
                Architecto, sunt. Accusantium quis fugit dolor iure eligendi
                exercitationem quo fugiat. Voluptate, obcaecati? Explicabo
                repellat eum nemo porro pariatur incidunt molestias soluta.
              </p>
            </div>
            <div className="relative -mb-6">
              <div>
                ...
                >
                  <div className="card mb-6 px-5 py-4 bg-black">
              ...
              <div>
                <div className="card mb-6 px-5 py-4 bg-black">
                  ...
                  <div className="mt-2">
                    <form className="rounded-md border border-gray-400 bg-black shadow-md">
